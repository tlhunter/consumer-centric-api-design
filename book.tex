...
\subsection{Choosing a Root API Location}
...
\section{Developer Experimentation}
...
cURL is a command-line utility available for many platforms (it even comes shipped with many Linux distributions). TODO

Services such as \href{http://documentation.mailgun.com/api_reference.html}{Mailgun}, Stripe, etc., provide sample cURL queries. When doing 2LA, sample queries are very easy to execute (3LA is often more difficult due to the required steps beforehand).
