...
Whenever possible, make using the API console easy and efficient for the developer. Perhaps you provide them with a default user account which resets every hour using a CRON job. Or, maybe by clicking a single button the application listing, the credentials are stored automatically and the developer can begin making API calls on behalf of their applicaion.
