...
\chapter{Resource Filtering for GET Requests}
...
\chapter{Respone Attribute Filtering for GET Requests}
...
The parameter name you choose isn't too important. It could be "filter" or "whitelist". In the examples below, I opted for an overly verbose option and called them "attribute\_whitelist". Consistency between different Endpoints is what is most important.
...
\chapter{JSON Request Body for POST, PUT, and PATCH Requests}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=90mm]{images/xml-vs-json-vs-soap-google-trends.png}
...
\section{JSON Schema ([json-schema.org](http://json-schema.org/))}

TODO

\section{JSON API ([jsonapi.org](http://jsonapi.org/))}

TODO

\section{Siren ([sirenspec.org](http://sirenspec.org))}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=90mm]{images/api-console.png}
