...
\textbf{Sending a Text or Email (Two Endpoints)}
...
\section{Respone Attribute Filtering}
...
\section{JSON Attributes}

dates and types and stuff
...
Figure ~\ref{fig:twitteroauth} is a screen you've likely seen while using Twitter.
