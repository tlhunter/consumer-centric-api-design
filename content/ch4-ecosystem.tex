...
\begin{figure}[!htb]
\centering
\includegraphics[width=1.75in]{images/two-legged.eps}
...
The HTTP protocol gives us a header called \texttt{Authorization} for passing around this sort of information. While there are many different ways to do API authorization, many of them make use of this header in some manner.

\subsubsection{Basic HTTP Authentication}

\begin{figure}[ht!]
\centering
\includegraphics[width=3.8in]{images/basic-http-auth.png}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=1.75in]{images/three-legged.eps}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=3.8in]{images/permissions-twitter.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=3.8in]{images/permissions-consumer.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=3.8in]{images/apigee-analytics.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=3.8in]{images/api-console.png}
